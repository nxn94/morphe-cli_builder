...
// APKMirror API credentials - use environment variables if available, otherwise use defaults
const APK_MIRROR_API_USER = process.env.APK_MIRROR_API_USER || "api-apkupdater";
const APK_MIRROR_API_PASS = process.env.APK_MIRROR_API_PASS || "rm5rcfruUjKy04sMpyMPJXW8";
